...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="JavaScript" type="text/javascript">
        $(document).ready(function () {
            debugger;
            //var hgt = parseFloat($("#ContentPlaceHolder1_grdCustom").height() - $(".grid tr:first").height()) + parseFloat($("#dHeaderHight table:first").height()) + parseFloat($("#dBodyHight").height()) + 8;
            var products = $(".products table");
            $("#hiddenProducts").html("");

            //$("#dHeaderHight table:first")
            $("#hiddenProducts").append($("#dHeaderHight table:first")[0].outerHTML);
            $("#hiddenProducts table:first").attr("width", "700");
            var content = "<div style='width:700px'>";
            $.each(products, function (count, item) {
                //products
                content += item.outerHTML + "<br/>";
                //$("#hiddenProducts").append(item.outerHTML);
                //$("#hiddenProducts").append("<br/>");
            });
            $("#hiddenProducts").append(content+"</div>");
            $("#hiddenProducts").append($("#dBodyHight table:first")[0].outerHTML);
            $("#hiddenProducts table:last").attr("width", "700px");
            //$('#spnH').text(hgt);
            $("#hdnHeight").val($("#hiddenProducts").height());
           // $("#hiddenProducts").html("");
            $("ol").attr('class', '');
            $(".date").datepicker();
            $('.time').ptTimeSelect();
            ...
            var count = $('#ContentPlaceHolder1_HiddenFieldtotalAmount').val();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="right_panel">
        ...
        <div id="hiddenProducts" style="width:700px;display:none">

        </div>
        <asp:HiddenField ID="hdnHeight" runat="server" ClientIDMode="Static" />
            ...
            <div id="tabs-1" style="background-color: #FFFFFF;">
                <div class="form_panel shutter_proposal" style="background-color: #FFFFFF; background: none;">
                    ...
                    <asp:Literal ID="LiteralHeader" runat="server"></asp:Literal><br />
                     <div id="dHeaderHight">
                    <asp:Literal ID="LiteralHeaderSecondPart" runat="server"></asp:Literal><br />
                    </div>
